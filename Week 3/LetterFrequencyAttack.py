...
def printString(S, N):
	...
	# cipher text
	freq = [13.33, 11.67, 8.33, 8.33, 7.5, 6.67,
         	5.83, 5.0, 5.0, 4.17, 4.17, 
          	3.33, 3.33, 2.5, 2.5, 1.67, 
...
# Given string
S = "UZQSOVUOHXMOPVGPOZPEVSGZWSZOPFPESXUDBMETSXAIZVUEPHZHMDZSHZOWSFPAPPDTSVPQUZWYMXUZUHSXEPYEPOPDZSZUFPOMBZWPFUPZHMDJUDTMOHMQ"
N = len(S)
